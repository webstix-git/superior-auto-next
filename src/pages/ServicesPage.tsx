...
const services = [
  {
    ...
    description: "From minor dents to major structural damage, our I-CAR Gold Class certified technicians restore your vehicle to its pre-accident condition using the latest equipment and techniques.",
    features: [
  ...
  },
  {
    ...
    description: "Life doesn't stop at 5 PM, and neither does your access to our services. Our secure night drop-off box allows you to leave your vehicle at your convenience—any time, day or night.",
    features: [
  ...
  },
  {
    ...
    description: "Our commitment to the environment goes beyond words. We use water-based paint solvents that are better for the planet while delivering the same—or better—quality finish you expect.",
    features: [
      ...
      <section className="py-16 md:py-24 bg-card">
        <div className="container">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { step: "1", title: "Free Estimate", desc: "Bring in your vehicle or send photos for a detailed estimate." },
              { step: "2", title: "Insurance Handling", desc: "We work directly with your insurance company." },
              { step: "3", title: "Expert Repairs", desc: "Our certified technicians restore your vehicle." },
              { step: "4", title: "Quality Delivery", desc: "Final inspection and return of your vehicle." }
            ].map((item, index) => (
