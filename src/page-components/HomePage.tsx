        ...
        <div className="container relative py-20 md:py-32">
          <div className="max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-white/80 mb-8">
              Family-owned for over 55 years, we take the stress out of collision
              repair. Expert craftsmanship, honest service, and a commitment to
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute top-0 left-0 w-2/5 z-10">
                <img
                  src={aboutUsSmall}
                  alt="Superior Auto Body team in Eau Claire, Wisconsin"
              ...
              <div className="flex items-center gap-4 mt-6 ml-16 p-4 bg-card rounded-lg shadow-sm border">
                ...
                <p className="text-base text-muted-foreground">
                  Superior Auto Body is a family-owned business that has been
                  serving the Chippewa Valley since 1971.
                </p>
              </div>
            </div>
            ...
            <div>
              <p className="text-base font-medium text-primary mb-2">
                Welcome to Superior Auto Body
              </p>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Trusted Collision Repair with a Legacy of Quality and Care
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                At Superior Auto Body, we're proud to be your go-to source for
                expert collision repair right here in Eau Claire. As a
                family-owned business with deep local roots, we've spent over
                five decades perfecting our craft and building lasting
                relationships with our customers. Whether you need minor dent
                repair, major collision work, or a complete restoration, we're
                here to bring your vehicle back to life with care and precision.
              </p>
              <Button size="lg" asChild className="text-base">
      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              See the quality craftsmanship that has made us the trusted choice
              for over 55 years.
            </p>
          </div>
